      ...
      !  Revision 1.2  2006/08/22 15:54:36  pchatela
...
!     &                  lmyeps).AND.(ABS(corner(2,j,isub)-corner(2,jj,jsub)) &
!     &                  .LT.lmyeps)) THEN
                     IF((ABS(corner(1,j,isub)-corner(1,jj,jsub)).LT.   &
...
!                     IF((ABS(corner(1,j,isub)-corner(1,jj,jsub)).LT.   &
!     &                  lmyeps).AND.(ABS(corner(2,j,isub)-corner(2,jj,jsub)) &
!     &                  .LT.lmyeps).AND.(ABS(corner(3,j,isub)-  &
!     &                  corner(3,jj,jsub)).LT.lmyeps)) THEN
                     IF((ABS(corner(1,j,isub)-corner(1,jj,jsub)).LT.   &
     &                  lmyeps*(max_sub(1,isub)-min_sub(1,isub))).AND. &     
     &                  (ABS(corner(2,j,isub)-corner(2,jj,jsub)).LT.   &
