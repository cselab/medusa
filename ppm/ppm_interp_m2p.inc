      ...
      !-------------------------------------------------------------------------
      !     
      !     Purpose      : mesh to particle interpolation. The 3D versions
      !                    for lda.LT.5 are explicitly unrolled. All 3D
      !                    version are unrolled over the kernel support.
      ...
      !     Added B-Spline 2 with Simone s fix. It could be optimized, by skipping a
      !     couple of variable definitions in the BSp2 scheme.
      !
      ...
      !     Added unrolled versions for all vector cases. Added 3D scalar case and
      !     2D vector case. All 3D cases are unrolled over the kernel. Changed
      !     to use ppm_check_topoid and ppm_check_meshid.
      !
...
!CDIR NODEP
           ...
           DO ip = 1,store_info(isub)
              iq    = list_sub(isub,ip)
              x0  = (xp(1:2,iq)-min_phys(1:2,topoid))*dxi(1:2)
...
#else
up(1:2,iq) = up(1:2,iq) + &
&a10a20a30*field_up(1:2,ip10,ip20,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a20a30*field_up(1:2,ip11,ip20,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a20a30*field_up(1:2,ip12,ip20,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a20a30*field_up(1:2,ip13,ip20,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a21a30*field_up(1:2,ip10,ip21,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a21a30*field_up(1:2,ip11,ip21,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a21a30*field_up(1:2,ip12,ip21,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a21a30*field_up(1:2,ip13,ip21,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a22a30*field_up(1:2,ip10,ip22,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a22a30*field_up(1:2,ip11,ip22,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a22a30*field_up(1:2,ip12,ip22,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a22a30*field_up(1:2,ip13,ip22,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a23a30*field_up(1:2,ip10,ip23,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a23a30*field_up(1:2,ip11,ip23,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a23a30*field_up(1:2,ip12,ip23,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a23a30*field_up(1:2,ip13,ip23,ip30,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a20a31*field_up(1:2,ip10,ip20,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a20a31*field_up(1:2,ip11,ip20,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a20a31*field_up(1:2,ip12,ip20,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a20a31*field_up(1:2,ip13,ip20,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a21a31*field_up(1:2,ip10,ip21,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a21a31*field_up(1:2,ip11,ip21,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a21a31*field_up(1:2,ip12,ip21,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a21a31*field_up(1:2,ip13,ip21,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a22a31*field_up(1:2,ip10,ip22,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a22a31*field_up(1:2,ip11,ip22,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a22a31*field_up(1:2,ip12,ip22,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a22a31*field_up(1:2,ip13,ip22,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a23a31*field_up(1:2,ip10,ip23,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a23a31*field_up(1:2,ip11,ip23,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a23a31*field_up(1:2,ip12,ip23,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a23a31*field_up(1:2,ip13,ip23,ip31,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a20a32*field_up(1:2,ip10,ip20,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a20a32*field_up(1:2,ip11,ip20,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a20a32*field_up(1:2,ip12,ip20,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a20a32*field_up(1:2,ip13,ip20,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a21a32*field_up(1:2,ip10,ip21,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a21a32*field_up(1:2,ip11,ip21,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a21a32*field_up(1:2,ip12,ip21,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a21a32*field_up(1:2,ip13,ip21,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a22a32*field_up(1:2,ip10,ip22,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a22a32*field_up(1:2,ip11,ip22,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a22a32*field_up(1:2,ip12,ip22,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a22a32*field_up(1:2,ip13,ip22,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a23a32*field_up(1:2,ip10,ip23,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a23a32*field_up(1:2,ip11,ip23,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a23a32*field_up(1:2,ip12,ip23,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a23a32*field_up(1:2,ip13,ip23,ip32,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a20a33*field_up(1:2,ip10,ip20,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a20a33*field_up(1:2,ip11,ip20,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a20a33*field_up(1:2,ip12,ip20,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a20a33*field_up(1:2,ip13,ip20,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a21a33*field_up(1:2,ip10,ip21,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a21a33*field_up(1:2,ip11,ip21,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a21a33*field_up(1:2,ip12,ip21,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a21a33*field_up(1:2,ip13,ip21,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a22a33*field_up(1:2,ip10,ip22,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a22a33*field_up(1:2,ip11,ip22,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a22a33*field_up(1:2,ip12,ip22,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a22a33*field_up(1:2,ip13,ip22,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a10a23a33*field_up(1:2,ip10,ip23,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a11a23a33*field_up(1:2,ip11,ip23,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a12a23a33*field_up(1:2,ip12,ip23,ip33,isub)
up(1:2,iq) = up(1:2,iq) + &
&a13a23a33*field_up(1:2,ip13,ip23,ip33,isub)
...
#else
up(1:3,iq) = up(1:3,iq) + &
&a10a20a30*field_up(1:3,ip10,ip20,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a20a30*field_up(1:3,ip11,ip20,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a20a30*field_up(1:3,ip12,ip20,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a20a30*field_up(1:3,ip13,ip20,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a21a30*field_up(1:3,ip10,ip21,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a21a30*field_up(1:3,ip11,ip21,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a21a30*field_up(1:3,ip12,ip21,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a21a30*field_up(1:3,ip13,ip21,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a22a30*field_up(1:3,ip10,ip22,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a22a30*field_up(1:3,ip11,ip22,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a22a30*field_up(1:3,ip12,ip22,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a22a30*field_up(1:3,ip13,ip22,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a23a30*field_up(1:3,ip10,ip23,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a23a30*field_up(1:3,ip11,ip23,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a23a30*field_up(1:3,ip12,ip23,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a23a30*field_up(1:3,ip13,ip23,ip30,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a20a31*field_up(1:3,ip10,ip20,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a20a31*field_up(1:3,ip11,ip20,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a20a31*field_up(1:3,ip12,ip20,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a20a31*field_up(1:3,ip13,ip20,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a21a31*field_up(1:3,ip10,ip21,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a21a31*field_up(1:3,ip11,ip21,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a21a31*field_up(1:3,ip12,ip21,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a21a31*field_up(1:3,ip13,ip21,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a22a31*field_up(1:3,ip10,ip22,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a22a31*field_up(1:3,ip11,ip22,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a22a31*field_up(1:3,ip12,ip22,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a22a31*field_up(1:3,ip13,ip22,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a23a31*field_up(1:3,ip10,ip23,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a23a31*field_up(1:3,ip11,ip23,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a23a31*field_up(1:3,ip12,ip23,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a23a31*field_up(1:3,ip13,ip23,ip31,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a20a32*field_up(1:3,ip10,ip20,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a20a32*field_up(1:3,ip11,ip20,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a20a32*field_up(1:3,ip12,ip20,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a20a32*field_up(1:3,ip13,ip20,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a21a32*field_up(1:3,ip10,ip21,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a21a32*field_up(1:3,ip11,ip21,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a21a32*field_up(1:3,ip12,ip21,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a21a32*field_up(1:3,ip13,ip21,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a22a32*field_up(1:3,ip10,ip22,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a22a32*field_up(1:3,ip11,ip22,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a22a32*field_up(1:3,ip12,ip22,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a22a32*field_up(1:3,ip13,ip22,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a23a32*field_up(1:3,ip10,ip23,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a23a32*field_up(1:3,ip11,ip23,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a23a32*field_up(1:3,ip12,ip23,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a23a32*field_up(1:3,ip13,ip23,ip32,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a20a33*field_up(1:3,ip10,ip20,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a20a33*field_up(1:3,ip11,ip20,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a20a33*field_up(1:3,ip12,ip20,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a20a33*field_up(1:3,ip13,ip20,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a21a33*field_up(1:3,ip10,ip21,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a21a33*field_up(1:3,ip11,ip21,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a21a33*field_up(1:3,ip12,ip21,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a21a33*field_up(1:3,ip13,ip21,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a22a33*field_up(1:3,ip10,ip22,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a22a33*field_up(1:3,ip11,ip22,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a22a33*field_up(1:3,ip12,ip22,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a22a33*field_up(1:3,ip13,ip22,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a10a23a33*field_up(1:3,ip10,ip23,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a11a23a33*field_up(1:3,ip11,ip23,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a12a23a33*field_up(1:3,ip12,ip23,ip33,isub)
up(1:3,iq) = up(1:3,iq) + &
&a13a23a33*field_up(1:3,ip13,ip23,ip33,isub)
...
!CDIR NODEP
    ...
    &       __LINE__,info)
     ...
     !  the subdomains. WHY THIS IS EMPTY ???
     !  Phil: This is probably some remnant of ppm_interp_p2m... It has nothing 
     !  to do here. 
     !--------------------------------------------------------------------------
