      ...
      !  Changed arguments for fftw routines from INTEGER to INTEGER, DIMENSION(1)
      !  for  NAG compiler
      !
...
#include "ppm_define.h"
      ...
      COMPLEX(MK), DIMENSION(:,:),           POINTER   :: data_comp => null()
      COMPLEX(MK), DIMENSION(:,:),           POINTER   :: data_compl => null()
      ...
      INTEGER , DIMENSION(:,:), POINTER       :: istart_xpen_complex   => null()
      INTEGER , DIMENSION(:,:), POINTER       :: istart_ypen => null()
      INTEGER , DIMENSION(:,:), POINTER       :: istart_trans => null()
      INTEGER , DIMENSION(:,:), POINTER       :: istart_zpen => null()
      INTEGER , DIMENSION(:,:), POINTER       :: ndata => null()
      INTEGER , DIMENSION(:,:), POINTER       :: ndata_xpen_complex => null()
      INTEGER , DIMENSION(:,:), POINTER       :: ndata_ypen => null()
      INTEGER , DIMENSION(:,:), POINTER       :: ndata_trans => null()
      INTEGER , DIMENSION(:,:), POINTER       :: ndata_zpen => null()
      INTEGER , DIMENSION(:,:), POINTER       :: ndata_slab => null()
...
!      topo_id=1 ! to be given by the user
!      mesh_id_xpen=1
