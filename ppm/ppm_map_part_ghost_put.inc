      ...
      !  ghost_pop routine
      !-------------------------------------------------------------------------
! so either we pass the ppm_user_hack to the ghost_pop OR we copy the userpassed
! array to the internally stored ppm_ghosthack used (and NOT passed) by the 
! ghost_pop() ... let us see !
!     DO i
