      ...
      !  Bug fix: a ghost could incorrectly be send more than once to a processor;
      !  introducing the lghost(:) array fixed this problem.
      !
     ...
     &        'global send buffer pointer PPM_PSENDBUFFER',__LINE__,info)
          GOTO 9999
      ENDIF
! now allocated and used in ppm_map_part_send
