      ...
      INTEGER                :: iopt,ld,ud,maxmeshid,kk,i,j,meshid
     ...
     &       __LINE__,info)
      ...
      ppm_cart_mesh(meshid,topoid)%nnodes = ndata(1:ppm_dim,1:nsubs)
      ppm_cart_mesh(meshid,topoid)%istart = istart(1:ppm_dim,1:nsubs)
      ppm_cart_mesh(meshid,topoid)%Nm     = Nm(1:ppm_dim)
