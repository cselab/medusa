      ...
      SUBROUTINE ppm_hamjac_reinit_loc_step_3dd (phi, tphi, iloc, np, trgt, res, topo_id, &
           &                          mesh_id, ghostsize, info)
#endif
#elif __MODE == __VEC
#if   __KIND == __SINGLE_PRECISION
      SUBROUTINE ppm_hamjac_reinit_loc_step_3dsV (phi, idx, tphi, iloc, np, trgt, res, &
           &                          topo_id, mesh_id, ghostsize, info)
#elif __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_hamjac_reinit_loc_step_3ddV (phi, idx, tphi, iloc, np, trgt, res, &
           &                          topo_id, mesh_id, ghostsize, info)
#endif
#endif
