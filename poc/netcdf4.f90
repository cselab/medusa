...
!
 module netcdf
  ...
  include "netcdf4_externals.inc"
  include "netcdf_overloads.inc"
  include "netcdf4_overloads.inc"
  include "netcdf_visibility.inc"
  include "netcdf4_visibility.inc"
contains
  include "netcdf_file.inc"
  include "netcdf4_file.inc"
  include "netcdf_dims.inc"
  include "netcdf_attributes.inc"
  include "netcdf4_variables.inc"
  include "netcdf_text_variables.inc"
  include "netcdf_expanded.inc"
  include "netcdf4_eightbyte.inc"
  include "netcdf4_func.inc"
end module netcdf
